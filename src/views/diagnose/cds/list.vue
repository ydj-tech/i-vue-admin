      ...
      <el-card class="box-card">
        ...
        <div style="margin-bottom:50px;">
          <div class="filter-container">
            <router-link to="/diagnose/cds/create">
            ...
            >
              <el-form-item label>
                <el-input v-model="code" placeholder="数据流编号" />
              </el-form-item>
              <el-form-item>
          ...
          >
            ...
            <el-table-column label="命令字" align="center">
              <template slot-scope="scope">
...
import { pageList, deleteCds } from "@/api/diagnose/cds";
import {
  eventStatusOptions,
  percentStageOptions
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      this.$router.push({ path: "/diagnose/cds/edit/" + row.sn });
    },
    handleDelete(row) {
      deleteCds(row.sn).then(response => {
